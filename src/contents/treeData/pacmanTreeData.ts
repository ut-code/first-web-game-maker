...
const pacmanTreeData = new TreeItem(
  ...
  undefined,
  [
    new TreeItem("HTML のテンプレート", vscode.TreeItemCollapsibleState.None, {
      command: "first-web-game-maker.insertTemplateHtmlAllAtTop",
      title: "",
    }),
    new TreeItem(
      "JavaScript のテンプレート",
      ...
      {
        command: "first-web-game-maker.insertTemplateJsAllAtTop",
        title: "",
      }
    ),
    new TreeItem(
